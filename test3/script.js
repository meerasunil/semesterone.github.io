  ...
  .eachPage(
    function page(records, fetchNextPage) {
      ...
      records.forEach(function (record, index) {
        ...
        record.fields.Brand.forEach((Brand) => {
          if (!Brand.includes(Brand)) Brand.push(Brand);
        });
         ...
         airtableItem.setAttribute("data-Date", record.fields.Date);
        ...
        */
        ...
        // render the value of the record's title
        drawerButtonInfo.innerHTML = `${record.fields.rating}, ${record.fields.packagers[0]}`;
        // append the button element to the airtableItem div element created above
        ...
        */
        ...
        drawerContentDescription.innerHTML = record.fields.Brand;
